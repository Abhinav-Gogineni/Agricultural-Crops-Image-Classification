...
Original file is located at
    https://colab.research.google.com/drive/1hZzDsu0qTob1GSms-Ew_EK4zdvbIuHvJ
...
src_folder = "/content/drive/MyDrive/AIClub_AP_Abhinav_Gogineni/Project/Train_AC"
# Provide the destination folder
dest_folder = "/content/drive/MyDrive/AIClub_AP_Abhinav_Gogineni/Project/Test_AC"
